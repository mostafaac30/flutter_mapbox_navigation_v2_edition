...
//import com.mapbox.navigation.examples.databinding.NavigationActivityBinding
...
class NavigationActivity : AppCompatActivity() {
    private var mapbox_access_token: String? = null
...
// remove the route reference from camera position evaluations
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapbox_access_token = PluginUtilities.getResourceFromContext(this.applicationContext, "mapbox_access_token")
